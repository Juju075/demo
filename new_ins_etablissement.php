...
/*
if(isset($_POST['etablissement'],$_POST['ins_descriptif'],$_FILES['image']) AND !empty ($_POST['etablissement']) AND !empty ($_POST['ins_descriptif'] AND !empty($_FILES['image']['name']))){
            ...
            echo '<pre>';
                ...
                if($_FILES['image']['size'] <= $tailleMax){ // fichier dans le serveur temp
                    ...
                    if(in_array($extensionUpload, $extensionsValides)){
                        ...
                        $rename = strlower(substr($_POST['etablissement']),3) .".". $_SESSION['id_user'];
