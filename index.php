...
<div id ="container">
    ...
    <div class="bloc_elements"><!-- elements 2-->
        <div class="sous_elements"><img src="images/gbaf_logo.jpg" alt="image" height="130px"></div><!-- Fin sous_elements-1 -->
        <div class="sous_elements"><p>BIENVENUE<br>
                ...
                En vous connectant sur ce site,vous acceptez l'utilisation de<br> cookies à des fins de mesure d'audience.<br> <strong><a href="https://www.cnil.fr/professionnel" target="_blank">En savoir plus</a></strong></p>
        ...
        <div class="sous_elements">
            <form method="post" action="php/execution.php">
                    ...
                    <p font style="color:red;">Mauvais identifiant ou mot de passe !</p> -->
